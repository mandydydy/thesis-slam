  ...
  initialized_(false)
{
  ...
  if (!nh_private_.getParam ("publish_debug_topics", publish_debug_topics_))
    ...
    /*rewrite orientation  Mengdi*/
  if (!nh_private_.getParam ("reinitialize", reinitialize_))
      reinitialize_= false;
  ...
  resetSrv = nh_.advertiseService("/reset_rotation", &ImuFilterRos::resetOrigin, this);
}
...
/* reinitialize the orientation Mengdi*/
bool ImuFilterRos::resetOrigin(imu_filter_madgwick::reInit::Request &req,
                               imu_filter_madgwick::reInit::Response &res)
{
    ROS_INFO("reinitialize orientation");
    geometry_msgs::Quaternion init_q;
...
// initialize time
    last_time_ = req.header.stamp;
    //reinitialize_ = false;
    //nh_private.setParam("reinitialize", false);
  return true;
}
